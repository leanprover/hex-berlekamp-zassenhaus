...
require HexBerlekamp from git
  "https://github.com/leanprover/hex-berlekamp.git" @ "v0.2.0"

require HexHensel from git
  "https://github.com/leanprover/hex-hensel.git" @ "v0.2.0"

require HexLLL from git
  "https://github.com/leanprover/hex-lll.git" @ "v0.2.0"
...
require HexPrimality from git
  "https://github.com/leanprover/hex-primality.git" @ "v0.2.0"

require HexPoly from git
  "https://github.com/leanprover/hex-poly.git" @ "v0.2.0"

require HexMatrix from git
  "https://github.com/leanprover/hex-matrix.git" @ "v0.2.0"

require HexModArith from git
  "https://github.com/leanprover/hex-mod-arith.git" @ "v0.2.0"

require HexPolyZ from git
  "https://github.com/leanprover/hex-poly-z.git" @ "v0.2.0"
